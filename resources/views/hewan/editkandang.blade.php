...
route('hewan.updatekandang', $data->id_kandang) }}">
...
<div class="mb-3">
<label for="jenis_k" class="form-label">Jenis Kandang</label>
<input type="text" class="form-control"id="jenis_k" name="jenis_k" value="{{ $data->jenis_k }}">
</div>
<div class="mb-3">

<label for="tipe_k" class="form-label">Tipe Kandang</label>
<input type="text" class="form-control"
id="tipe_k" name="tipe_k" value="{{ $data->tipe_k }}">
</div>
<div class="mb-3">
